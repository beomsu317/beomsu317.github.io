...
- `RDI`, `RSI`, `RDX`, `RCX`, `R8`,`R9` : 정수 메모리 주소 인수 전달
- `XMM0`, `XMM1`, `XMM2`, `XMM3`, `XMM4`, `XMM5`, `XMM6`, `XMM7` : 부동 소수점 인수 전달
...
bof를 통해 return address 변조를 할 수 있다. library address 실행 시마다 변경되므로 memory leak이 필요하다.
